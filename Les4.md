...
![constraint](les4/constraint_particle.png?right)Een ander soort constraint is een vaste-afstand constraint. Deze constraint zorgt ervoor dat 2 punten altijd op dezelfde afstand blijven. Als punten te ver van elkaar vandaan staan, worden ze naar elkaar toe verplaatst, als ze te dicht op elkaar staan worden ze naar buiten verplaatst. Door een vaste afstand in te stellen en de echte afstand berekenen, kan het verschil tussen hiertussen berekenen. Hierna kan de verschilvector van de 2 punten nemen, deze normaliseren en de helft van het verschil met deze vector vermenigvuldigen, en dit bij het ene punt optellen, en van het andere punt afhalen.

In de afbeelding hiernaast: bekend is punt A en B, dit zijn de posities van de 2 particles in de restraint. De bedoeling na de update is om deze op posities C en D zetten. Om A op positie C te zetten, moet eerst de vector AC berekend worden.
...
Deze constraint zal de afstand tussen 2 particles nu goed zetten. Dit veroorzaakt nu ook dynamisch gedrag. Stel dat er 3 punten op 1 lijn zijn, met een afstand van 50, en een gewenste afstand van 100, de punten A (0,0), B (50,0) en C (100,0)
